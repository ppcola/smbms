...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
			...
			<input type="hidden" id="totalPageCount" value="${userPage.totalPageCount}"/>
		  	<c:import url="rollpage.jsp">
	          	<c:param name="totalCount" value="${userPage.totalCount}"/>
	          	<c:param name="currentPageNo" value="${userPage.pageIndex}"/>
	          	<c:param name="totalPageCount" value="${userPage.totalPageCount}"/>
          	</c:import>
        </div>
    </section>
