...
<div class="right">
       ...
       <div class="search">
       <form method="post" action="${pageContext.request.contextPath }/sys/bill/list.do">
			<span>商品名称：</span>
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billPage.pageList }" varStatus="status">
 			...
 			<input type="hidden" id="totalPageCount" value="${billPage.totalPageCount}"/>
		  	<c:import url="rollpage.jsp">
	          	<c:param name="totalCount" value="${billPage.totalCount}"/>
	          	<c:param name="currentPageNo" value="${billPage.pageIndex}"/>
	          	<c:param name="totalPageCount" value="${billPage.totalPageCount}"/>
          	</c:import>
        </div>
    </section>
