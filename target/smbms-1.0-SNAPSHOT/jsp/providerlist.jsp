...
<div class="right">
        ...
        <div class="search">
        	<form method="post" action="${pageContext.request.contextPath }/sys/provider/list.do">
				<span>供应商编码：</span>
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${providerPage.pageList }" varStatus="status">
				<tr>
					<td>
			...
			<input type="hidden" id="totalPageCount" value="${providerPage.totalPageCount}"/>
		  	<c:import url="rollpage.jsp">
	          	<c:param name="totalCount" value="${providerPage.totalCount}"/>
	          	<c:param name="currentPageNo" value="${providerPage.pageIndex}"/>
	          	<c:param name="totalPageCount" value="${providerPage.totalPageCount}"/>
          	</c:import>
    </div>
</section>
